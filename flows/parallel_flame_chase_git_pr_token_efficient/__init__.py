"""Parallel Flame Chase Git/PR with token-efficient lane instructions."""
...
class Config(BaseConfig):
    """Freeze the token-efficient ablation and its controls."""
...
class Runtime(GitPRRuntime):
    ...
    mode_name = "git-pr-token-efficient"
